...
import otherCertificates from "@/data/other-certificates.json";

type Cert = (typeof otherCertificates)[number];

export default function OtherCertificates() {
  const [active, setActive] = useState<Cert | null>(null);

  return (
    <section id="other-certifications" className="relative py-24 px-5 md:px-8">
      <div className="mx-auto max-w-7xl">
        <SectionHeading eyebrow="Beyond Offensive Security" title="Other Certificates" />
      </div>
